    ...
    <div class="container">
        ...
        <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-100 rounded-lg p-8 border border-gray-200">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy-main mb-4">Zaufanie</h3>
                ...
                <div class="bg-gray-100 rounded-lg p-8 border border-gray-200">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy-main mb-4">Innowacyjność</h3>
                    <p class="text-brand-navy-main leading-relaxed">
                ...
                <div class="bg-gray-100 rounded-lg p-8 border border-gray-200">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy-main mb-4">Współpraca</h3>
                    <p class="text-brand-navy-main leading-relaxed">
