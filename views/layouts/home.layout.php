...
<body>
    ...
    <div id="logo-overlay" class="fixed inset-0 bg-black z-50 flex items-center justify-center pointer-events-none">
        <div id="logo-container" class="text-center">
            <!-- Logo in grayscale initially -->
            <img id="animated-logo" src="/assets/images/logos/logo-poziome-pomarancz.png" alt="Corpotech" class="h-32 mx-auto filter grayscale">
        </div>
    </div>
        ...
        <div class="container" style="padding-left: 0; padding-right: 0;">
            <div class="relative py-4 h-20" style="align-items: center;">
                ...
                <div id="header-logo-slot" class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-16">
                    <!-- Logo will be positioned here by animation -->
                </div>
    ...
    <!-- Main Content -->
    <main id="main-content" class="bg-brand-navy-main min-h-screen relative z-10 opacity-0">
        <?= $content ?? '' ?>
    </main>
    ...
    <div class="container text-center">
        ...
        <p class="text-lg text-gray-300 mb-8">Skontaktuj się z nami, aby omówić, jak możemy pomóc w rozwoju Twojego biznesu.</p>
