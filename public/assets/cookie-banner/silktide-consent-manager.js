...
class SilktideCookieBanner {
  ...
  handleCookieChoice(accepted) {
    ...
    // Ensure body scroll is restored even if modal wasn't open
    this.allowBodyScroll();
    this.showCookieIcon();
  ...
  getBannerContent() {
    ...
    // Silktide logo not rendered per instructions
    const silktideLogo = '';
...
(function () {
  ...
  // Domyślna konfiguracja – polska i spójna z brandingiem, zanim użytkownik ją nadpisze
  let config = {
    ...
    text: {
      banner: {
        description:
          '<p>Używamy plików cookies, aby zapewnić najlepsze doświadczenia podczas przeglądania naszej strony. Więcej informacji znajdziesz w <a href="/polityka-prywatnosci">Polityce prywatności</a>.</p>',
      ...
      preferences: {
        ...
        description:
          '<p>Szanujemy Twoją prywatność. W każdej chwili możesz zmienić preferencje dotyczące plików cookies. Ustawienia będą stosowane w obrębie tej witryny.</p>',
        creditLinkText: '',
  ...
  // Auto-init wyłączony – inicjalizacja nastąpi po dostarczeniu konfiguracji przez stronę
})();